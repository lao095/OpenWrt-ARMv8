...
merge_package master https://github.com/fw876/helloworld package/ssr luci-app-ssr-plus
merge_package main https://github.com/fw876/helloworld package/gn gn
...
rm -rf package/openwrt-passwall-packages/gn
